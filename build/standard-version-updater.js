 ...
 */
module.exports.readVersion = contents => /version: '(\d+\.\d+\.\d+)'/.exec(contents)[1];
 ...
 */
module.exports.writeVersion = (contents, version) => contents.replace(/(version: ')\d+.\d+.\d+'/, `$1${version}'`);